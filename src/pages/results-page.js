          ...
          <div className="top-container2">
            ...
            <div className="navigation-right2">
              <div className="navigation-menu2">
                ...
                <div className="explore2" onClick={onHotelsTextClick}>
                  Hotels
                </div>
        ...
        <div className="search-results">
          <div className="search-filters">
            ...
            <div className="booking-options">
              <b className="results3">Booking Options</b>
              <FormControlLabel
                className="component-1formcheckbox"
            ...
            <div className="flight-experience">
              <b className="results4">Flight Experience</b>
              <FormControlLabel
                className="component-1formcheckbox"
            ...
            <div className="airlines">
              <b className="results5">Airlines</b>
              <FormControlLabel
                className="component-1formcheckbox"
          ...
          <div className="results-section1">
            <div className="flight-cards">
              <div className="results6">10 out of 177 Results</div>
              ...
              <div className="primary-button1">
                ...
                <div className="search-flights5">Show more results</div>
              </div>
            </div>
            <div className="recently-booked">
              <div className="recently-booked-title">
                <b className="results7">Recently booked</b>
                <img
            ...
            <div className="newsletter-form-section1">
              ...
              <div className="subscribe-form1">
                <div className="form-header2">
                  <b className="results7">subscribe to our newsletter</b>
